...
export const DEFAULT_TAXAS = [
    ...
    {
        id: "taxa-crianca-fora",
        codigo: "crianca_fora",
        descricao: "CRIANÇA (FORA DO MUNICIPIO)",
        valor: 224.54,
        tipo: "sepultamento",
        active: true,
        isencao: false,
    ...
    {
        id: "taxa-adulto-terra",
        codigo: "adulto_terra",
        descricao: "ADULTO (TERRA)",
        valor: 112.27,
        tipo: "sepultamento",
        active: true,
        isencao: false,
    ...
    },
    {
        id: "taxa-adulto-fora",
        codigo: "adulto_fora",
        descricao: "ADULTO (FORA DO MUNICIPIO)",
        valor: 430.42,
        tipo: "sepultamento",
        active: true,
        isencao: false,
    ...
    },
    {
        id: "taxa-indigente",
        codigo: "indigente",
        descricao: "ISENÇÃO POR INDIGÊNCIA",
        valor: 0,
        tipo: "sepultamento",
        active: true,
        isencao: true,
...
export const NAME_CASE_FIELDS = new Set(["nome_fal", "filiacao_pai", "filiacao_mae", "nome_doutor", "nome_resp"]);

export const ALLOWED_FAL_INDI = new Set(["nome_fal", "sexo", "cor", "dh_falec", "causa_mortis", "obs_fal"]);

export const STEPS_DECEASED = ["Dados do Falecido", "Documentação", "Responsável", "Revisão"];
