...
import { LoadingOverlayRoot, LoadingCard, LoadingCircle, LoadingLogo, LoadingText } from "./styles";

export default function LoadingOverlay({ open = true, logoSrc = sgcLogo, alt = "Carregando", label = "" }) {
    if (!open) {
        return null;
    }
