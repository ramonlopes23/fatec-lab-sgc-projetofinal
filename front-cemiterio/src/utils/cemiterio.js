...
export const getCemiterioId = (cemiterio = {}) =>
    normalizeValue(cemiterio?.id ?? cemiterio?._id ?? cemiterio?.cemiterio_id ?? cemiterio?.cemeteryId ?? "");

export const getCemiterioName = (cemiterio = {}) =>
    normalizeValue(
        cemiterio?.name ??
            cemiterio?.nome ??
...
export const getCemiterioFoundation = (cemiterio = {}) =>
    normalizeValue(
        cemiterio?.foundation ?? cemiterio?.fundacao ?? cemiterio?.data_fundacao ?? cemiterio?.dt_fundacao ?? ""
    );
...
export const findCemiterioByReference = (value, cemiterios = []) => {
    ...
    return (
        (Array.isArray(cemiterios) ? cemiterios : []).find((cemiterio) => {
